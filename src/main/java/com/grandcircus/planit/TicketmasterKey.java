...
public class TicketmasterKey {
	...
	public TicketmasterKey(String city, String dateFrom, String dateTo){
		...
		setDateTo(dateTo);
		this.api = "https://app.ticketmaster.com/discovery/v2/events.json?apikey=9GWQl0TyQA2GKd6qcHEAMxL3VkwldGx3&radius=1&startDateTime="+dateFrom+"T00%3A00%3A00Z&endDateTime="+dateTo+"T00%3A00%3A00Z&city="+city;
	}
